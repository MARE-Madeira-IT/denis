...
export default (state = initialState, action = {}) => {
    switch (action.type) {
        case `${types.FETCH_TAXA_ABUNDANCE_SELECTOR}_PENDING`:
        ...
        case `${types.FETCH_TAXA_ABUNDANCE_SELECTOR}_REJECTED`:
        ...
        case `${types.FETCH_TAXA_ABUNDANCE_SELECTOR}_FULFILLED`:
            return {
                ...state,
                loading: false,
