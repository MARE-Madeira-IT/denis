...
export default (state = initialState, action = {}) => {
    switch (action.type) {
        ...
        case `${types.UPDATE_DEBRIS_TYPE}_PENDING`:
        case `${types.DELETE_DEBRIS_TYPE}_PENDING`:
            return {
                ...state,
                loading: true
            };
        ...
        case `${types.DELETE_DEBRIS_TYPE}_REJECTED`:
            return {
                ...state,
                loading: false,
            };
        ...
        case `${types.FETCH_DEBRIS_TYPE}_FULFILLED`:
            return {
                ...state,
                loading: false,
                current: {
        ...
        case `${types.DELETE_DEBRIS_TYPE}_FULFILLED`:
            return {
                ...state,
                loading: false,
        ...
        case `${types.CREATE_DEBRIS_TYPE}_FULFILLED`:
            return {
                ...state,
                data: [action.payload.data.data, ...state.data]
            };

        case `${types.UPDATE_DEBRIS_TYPE}_FULFILLED`:
            return {
                ...state,
