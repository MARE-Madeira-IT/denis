...
use App\Http\Requests\DebrisSizeRequest;
...
class DebrisSizeController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(DebrisSizeRequest $request)
    {
        $validator = $request->validated();
        $record = DebrisSize::create($validator);

        return new DebrisSizeResource($record);
    }
